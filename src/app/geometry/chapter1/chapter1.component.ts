  ...
  list: LaTex[] = [
    {
      eq: 'V = (a,b,c,d,e,f)',
      title: '向量',
      desc: 'a, b, c, d, e, f 为实数.在计算机图形学中，向量可以用来表示空间中的位置或方向。',
    },
    {
      eq: '\\begin{alignedat}{5}  P &\\rarr Translate &\\rarr P_T \\\\　V &\\rarr Rotate &\\rarr V_T \\end{alignedat}',
      title: '点的变换和坐标的旋转',
      desc: '下标字母 T 表示转换(transformed)',
    },
    {
      eq: '\\text{\\textbardbl}V\\text{\\textbardbl} = \\sqrt{V.x*V.x + V.y*V.y + V.z*V.z}',
      title: '向量长度计算',
      desc: '',
    },
    {
      // \dfrac{a-1}{b-1}
      eq: '\\text{\\^{V}} = \\dfrac{V}{\\text{\\textbardbl}V\\text{\\textbardbl}} ',
